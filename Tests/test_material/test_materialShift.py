...
class TestItemPage:
    ...
    def test_item_refreshsuccess(self, login_to_item):
        ...
        filter_results = self.item.filter_method('//span[text()=" 代码"]/ancestor::div[3]//span//span//span')
    ...
    def test_item_selectcodesuccess(self, login_to_item):
        ...
        sleep(1)
        # 点击工厂代码
        item.click_button('//div[text()="代码" and contains(@optid,"opt_")]')
        sleep(1)
        # 点击比较关系框
        item.click_button(
    ...
    def test_item_selectnodatasuccess(self, login_to_item):
        ...
        sleep(1)
        # 点击交付单号
        self.item.click_button('//div[text()="代码" and contains(@optid,"opt_")]')
        sleep(1)
        # 点击比较关系框
