...
class TestItemPage:
    ...
    def setup(self, login_to_item):
        ...
        req_input_edit_xpath_list = [
            "//div[@id='6njzhx0n-ho8j']//input",
            "//div[@id='khhkriyk-0m9x']//input",
            "//div[@id='t0h1k08u-anen']//input",
            "//div[@id='lq8ndnmh-jhyt']//input",
            "//div[@id='h7w1qh0j-am9c']//input"
        ]

        # 必填新增日期xpath
        req_date_add_xpath_list = ["//div[@id='r7yw5265-ocre']//input"]
        # 必填编辑日期xpath
        req_date_edit_xpath_list = ["//div[@id='47asrf4k-c7j6']//input"]
        ...
        all_input_add_xpath_list = [
            ...
            "//div[@id='ufo19135-6afd']//input",
            "//div[@id='5q8tx5rz-aoh7']//input",
