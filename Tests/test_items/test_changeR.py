...
class TestChangeRPage:
    ...
    def test_changer_addresourcefail(self, login_to_changeR):
        ...
        sleep(1)
        changeR.click_button(f'(//span[@class="vxe-cell--checkbox"])[{random_int}]')
        sleep(1)
        changeR.click_button(
    ...
    def test_changer_additemfail(self, login_to_changeR):
        ...
        sleep(1)
        changeR.click_button(f'(//span[@class="vxe-cell--checkbox"])[{random_int1}]')
        sleep(1)
        changeR.click_button(
            '(//div[@class="h-40px flex-justify-end flex-align-items-end b-t-s-d9e3f3"])[2]/button[1]'
        )
    ...
    def test_changer_delcancel(self, login_to_changeR):
        ...
        # 点击取消
        changeR.get_find_element_class("ivu-btn-text").click()
        # 定位第一行
    ...
    def test_changeR_deleteall(self, login_to_changeR):
        ...
        # 点击确定
        # 找到共同的父元素
        parent = changeR.get_find_element_class("ivu-modal-confirm-footer")
    ...
    def test_changeR_delete(self, login_to_changeR):
        ...
        parent_div = changeR.get_find_element_xpath(
        ...
        sleep(2)
        # 点击确认删除的按钮
        changeR.click_button('//button[@class="ivu-btn ivu-btn-primary ivu-btn-large"]')
        # 等待一段时间，确保删除操作完成
        sleep(1)
