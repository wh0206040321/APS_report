...
class TestResourceGroupPage:
    ...
    def test_resourcegroup_addall(self, login_to_resourcegroup):
        ...
        text_list = [
            '//label[text()="资源组代码"]/following-sibling::div//input',
            '//label[text()="资源组名称"]/following-sibling::div//input',
        ...
        select_list = [
            ...
            {"select": '//label[text()="分派资源量标志"]/following-sibling::div//i',
             "value": '//li[text()="与制造数量成比例"]'},
        ...
        sleep(2)
        resource.enter_texts(
            '//p[text()="资源组代码"]/ancestor::div[2]//input', input_value
        )
        sleep(1)
        resource.click_button(
        ...
        username = resource.get_find_element_xpath(
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_select2(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        driver.execute_script("document.body.style.zoom='1'")
        resource.right_refresh('资源组')
        resource.click_button('//p[text()="资源组代码"]/ancestor::div[2]/div[3]//i')
        sleep(1)
        ...
        sleep(1)
        resource.click_button('//p[text()="资源组代码"]/ancestor::div[2]//input')
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_select3(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        name = resource.get_find_element_xpath(
        ...
        resource.hover("包含")
        sleep(1)
        resource.select_input_resourceroup(first_char)
        sleep(1)
        eles = resource.finds_elements(By.XPATH, '//table[@class="vxe-table--body"]//tr//td[2]')
        sleep(1)
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_select4(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        name = resource.get_find_element_xpath(
            '//div[@class="vxe-table--body-wrapper body--wrapper"]/table[@class="vxe-table--body"]//tr[2]//td[2]'
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_select5(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        name = resource.get_find_element_xpath(
            '//div[@class="vxe-table--body-wrapper body--wrapper"]/table[@class="vxe-table--body"]//tr[2]//td[2]'
        ...
        resource.hover("符合结尾")
        sleep(1)
        resource.select_input_resourceroup(last_char)
        sleep(1)
        eles = resource.finds_elements(By.XPATH, '//table[@class="vxe-table--body"]//tr//td[2]')
        sleep(1)
        list_ = [ele.text for ele in eles]
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_clear(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        name = "3"
        sleep(1)
        ...
        resource.hover("包含")
        sleep(1)
        resource.select_input_resourceroup(name)
        sleep(1)
        resource.click_button('//p[text()="资源组代码"]/ancestor::div[2]/div[3]//i')
        resource.hover("清除所有筛选条件")
        sleep(1)
        ele = resource.get_find_element_xpath('//p[text()="资源组代码"]/ancestor::div[2]/div[3]//i').get_attribute(
            "class")
        resource.right_refresh('资源组')
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_ctrlIrepeat(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_ctrlI(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        resource.click_button('//table[@class="vxe-table--body"]//tr[2]//td[2]')
        ActionChains(driver).key_down(Keys.CONTROL).send_keys('i').key_up(Keys.CONTROL).perform()
        ...
        resource.select_input_resourceroup('1没有数据添加')
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_ctrlM(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        ...
        resource.click_button('//div[@class="vxe-modal--footer"]//span[text()="确定"]')
        resource.get_find_message()
        resource.select_input_resourceroup('1没有数据修改')
        ele2 = resource.get_find_element_xpath('(//table[@class="vxe-table--body"]//tr[1]/td[2])[1]').get_attribute(
            "innerText")
        assert ele1 == ele2
        assert not resource.has_fail_message()
    ...
    @allure.story("模拟多选删除")
    # @pytest.mark.run(order=1)
    def test_resourcegroup_shiftdel(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        resource.right_refresh('资源组')
        resource.click_button('//table[@class="vxe-table--body"]//tr[2]//td[2]')
        ...
        resource.click_button('//div[@class="vxe-modal--footer"]//span[text()="确定"]')
        resource.get_find_message()
        resource.select_input_resourceroup('1没有数据修改1')
        ele2 = resource.get_find_element_xpath('(//table[@class="vxe-table--body"]//tr[1]/td[2])[1]').get_attribute(
            "innerText")
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_ctrlC(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        resource.right_refresh('资源组')
        resource.click_button('//table[@class="vxe-table--body"]//tr[2]//td[2]')
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_shift(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        elements = ['(//table[@class="vxe-table--body"]//tr[1]//td[1])[2]',
                    '(//table[@class="vxe-table--body"]//tr[2]//td[1])[2]']
    ...
    # @pytest.mark.run(order=1)
    def test_resourcegroup_ctrls(self, login_to_resourcegroup):
        driver = login_to_resourcegroup  # WebDriver 实例
        resource = ResourcePage(driver)  # 用 driver 初始化 ResourcePage
        elements = ['(//table[@class="vxe-table--body"]//tr[1]//td[1])[2]',
                    '(//table[@class="vxe-table--body"]//tr[2]//td[1])[2]']
