...
class TestItemGroupPage:
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_select2(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        driver.execute_script("document.body.style.zoom='1'")
        item.right_refresh('物品组')
        item.click_button('//p[text()="物料组代码"]/ancestor::div[2]/div[3]//i')
        sleep(1)
        ...
        sleep(1)
        item.click_button('//p[text()="物料组代码"]/ancestor::div[2]//input')
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_select3(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        name = item.get_find_element_xpath(
        ...
        item.hover("包含")
        sleep(1)
        item.select_input_itemgroup(first_char)
        sleep(1)
        eles = item.finds_elements(By.XPATH, '//table[@class="vxe-table--body"]//tr//td[2]')
        sleep(1)
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_select4(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        name = item.get_find_element_xpath(
            '//div[@class="vxe-table--body-wrapper body--wrapper"]/table[@class="vxe-table--body"]//tr[2]//td[2]'
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_select5(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        name = item.get_find_element_xpath(
            '//div[@class="vxe-table--body-wrapper body--wrapper"]/table[@class="vxe-table--body"]//tr[2]//td[2]'
        ...
        item.hover("符合结尾")
        sleep(1)
        item.select_input_itemgroup(last_char)
        sleep(1)
        eles = item.finds_elements(By.XPATH, '//table[@class="vxe-table--body"]//tr//td[2]')
        sleep(1)
        list_ = [ele.text for ele in eles]
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_clear(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        name = "3"
        sleep(1)
        ...
        item.hover("包含")
        sleep(1)
        item.select_input_itemgroup(name)
        sleep(1)
        item.click_button('//p[text()="物料组代码"]/ancestor::div[2]/div[3]//i')
        item.hover("清除所有筛选条件")
        sleep(1)
        ele = item.get_find_element_xpath('//p[text()="物料组代码"]/ancestor::div[2]/div[3]//i').get_attribute(
            "class")
        item.right_refresh('物品组')
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_ctrlIrepeat(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        ...
        ele1 = item.get_find_element_xpath('(//table[@class="vxe-table--body"]//tr[1]/td[2])[2]').get_attribute(
            "innerText")
        item.click_button('//div[@class="vxe-modal--footer"]//span[text()="确定"]')
        message = item.get_find_element_xpath('//div[text()=" 记录已存在,请检查！ "]').get_attribute("innerText")
        item.click_button('//div[@class="ivu-modal-footer"]//span[text()="关闭"]')
        item.click_button('//div[@class="vxe-modal--footer"]//span[text()="取消"]')
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_ctrlI(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        item.click_button('//table[@class="vxe-table--body"]//tr[2]//td[2]')
        ActionChains(driver).key_down(Keys.CONTROL).send_keys('i').key_up(Keys.CONTROL).perform()
        ...
        item.select_input_itemgroup('1没有数据添加')
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_ctrlM(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        ...
        item.click_button('//div[@class="vxe-modal--footer"]//span[text()="确定"]')
        item.get_find_message()
        item.select_input_itemgroup('1没有数据修改')
        ele2 = item.get_find_element_xpath('(//table[@class="vxe-table--body"]//tr[1]/td[2])[1]').get_attribute(
            "innerText")
        assert ele1 == ele2
        assert not item.has_fail_message()
    ...
    @allure.story("模拟多选删除")
    # @pytest.mark.run(order=1)
    def test_itemgroup_shiftdel(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        item.right_refresh('物品组')
        item.click_button('//table[@class="vxe-table--body"]//tr[2]//td[2]')
        ActionChains(driver).key_down(Keys.CONTROL).send_keys('i').key_up(Keys.CONTROL).perform()
        item.click_button('(//table[@class="vxe-table--body"]//tr[1]/td[2])[2]')
        item.enter_texts('(//table[@class="vxe-table--body"]//tr[1]/td[2])[2]//input', '1没有数据修改1')
        sleep(1)
        ele1 = item.get_find_element_xpath(
            '(//table[@class="vxe-table--body"]//tr[1]/td[2])[2]//input').get_attribute(
            "value")
        item.click_button('//div[@class="vxe-modal--footer"]//span[text()="确定"]')
        item.get_find_message()
        item.select_input_itemgroup('1没有数据修改1')
        ele2 = item.get_find_element_xpath('(//table[@class="vxe-table--body"]//tr[1]/td[2])[1]').get_attribute(
            "innerText")
        assert ele1 == ele2 == '1没有数据修改1'
        assert not item.has_fail_message()
        item.select_input_itemgroup('1没有数据修改')
        before_data = item.get_find_element_xpath('(//span[contains(text(),"条记录")])[1]').text
        ...
        item.wait_for_loading_to_disappear()
        after_data = item.get_find_element_xpath('(//span[contains(text(),"条记录")])[1]').text
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_ctrlC(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        item.right_refresh('物品组')
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_shift(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        elements = ['(//table[@class="vxe-table--body"]//tr[1]//td[1])[2]',
                    '(//table[@class="vxe-table--body"]//tr[2]//td[1])[2]']
    ...
    # @pytest.mark.run(order=1)
    def test_itemgroup_ctrls(self, login_to_itemgroup):
        driver = login_to_itemgroup  # WebDriver 实例
        item = ItemPage(driver)  # 用 driver 初始化 ItemPage
        elements = ['(//table[@class="vxe-table--body"]//tr[1]//td[1])[2]',
                    '(//table[@class="vxe-table--body"]//tr[2]//td[1])[2]']
