...
#         home.click_button('//div[./button[.//span[text()="切换并保存"]]]//span[text()="取消"]')
#         home.click_save_button()
#         num = home.count_div_elements()
...
#         assert not home.has_fail_message()
#
#     @allure.story("切换模版点击切换不保存，则修改的内容不保存，并且切换到别的模版上")
#     # @pytest.mark.run(order=1)
...
#         assert not home.has_fail_message()
#
#     @allure.story("切换模版点击切换并保存，修改的内容保存")
#     # @pytest.mark.run(order=1)
...
#         home.click_template()
#         home.click_button('//div[./span[text()=" 测试模版confirm "]]/span[text()=" 加载模板 "]')
#         home.click_button('//button[.//span[text()="切换并保存"]]')
#         home.wait_for_loading_to_disappear()
#         num1 = home.count_div_elements()
#         style = home.get_find_element_xpath(
#             '//div[./span[text()=" 测试模版confirm "]]/span[text()=" 加载模板 "]').get_attribute("style")
...
#         assert not home.has_fail_message()
#
#     @allure.story("切换模版点击切换并保存，刷新页面，不点击保存，则修改的内容不保存")
#     # @pytest.mark.run(order=1)
...
#         assert not home.has_fail_message()
#
#     @allure.story("切换模版点击切换并保存，刷新页面，点击保存，则修改的内容保存")
#     # @pytest.mark.run(order=1)
