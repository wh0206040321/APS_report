...
class TestAffairsPage:
    ...
    # @pytest.mark.run(order=1)
    def test_affairs_process_updat1(self, login_to_affairs):
        driver = login_to_affairs  # WebDriver 实例
        affairs = AffairsPage(driver)  # 用 driver 初始化 AffairsPage
        name = "测试流程7"
        before_ = "测试流程8"
