...
class TestSLanguagePage:
    ...
    def test_language_updatesuccess1(self, login_to_language):
        ...
        eles2 = language.get_find_element_xpath('//table[@class="vxe-table--body"]//tr[1]/td[2]').text
    ...
    def test_language_updatesuccess2(self, login_to_language):
        ...
        message = language.get_find_message()
        language.select_input_language(after_name)
        eles1 = language.get_find_element_xpath('//table[@class="vxe-table--body"]//tr[1]/td[3]').text
        eles2 = language.get_find_element_xpath('//table[@class="vxe-table--body"]//tr[1]/td[4]').text
        eles3 = language.get_find_element_xpath('//table[@class="vxe-table--body"]//tr[1]/td[5]').text
